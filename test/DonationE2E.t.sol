...
contract DonationE2E is Test {
    ...
    function test_e2e_baseline() public { vm.createSelectFork("https://ethereum-rpc.publicnode.com"); _fresh(); _runClaim(false); }
    function test_e2e_attack()   public { vm.createSelectFork("https://ethereum-rpc.publicnode.com"); _fresh(); _runClaim(true); }
}
